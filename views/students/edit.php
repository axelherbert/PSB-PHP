<a href="?action=students/list" class="btn btn-primary mb-3">
    Retour
</a>
<div class="card">
    <div class="card-body">
        <h5 class="card-title text-primary">Modifier un étudiant</h5>
        <form class="row mt-2" action="?action=students/edit&id=<?= $userEdited['id'] ?>" method="post">
